...
#ifndef SRC_PROJECT_OPERATION_UPPERFLATTEN_H_
#define SRC_PROJECT_OPERATION_UPPERFLATTEN_H_
...
#include <memory>
class UpperFlatten: public Operation {
public:
	UpperFlatten();
	virtual ~UpperFlatten() = default;
